  ...
  return (
    <div className='app'>
     <div className='container'>
       <div className='total_amount_card' style={{ backgroundImage: `linear-gradient(to right,  rgba(233, 125, 90, 100%), rgba(234, 254, 95, 100%))`}}>
       ...
       <div className='right'>
          ...
          <div className='card_text'>
            <h3 className={counter<0 ? 'negative' : 'positive'}>{counter}</h3>
          </div>
       </div>
       <form >
